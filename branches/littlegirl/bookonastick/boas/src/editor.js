...
// Little Girl: This function was added for special treatment of list line-height:
function FullSpecialTagThis(tag) {
	woas._editor.setSelectedText('<'+tag+' style="line-height:50%;">\n','</'+tag+'>');
}

// Little Girl: This function was added for unusual list types:
...
function setImage(starttag,endtag) {
	// Little Girl: I added location to the following line to make it more obvious what you need to type in when you click on the Image link button in the editor:
...
function setTag() {
        //Little Girl: I added to the prompt in the following line for clarity:
