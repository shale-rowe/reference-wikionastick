...
woas['i18n'] = {
	...
	ERR_NO_PWD: "Please click the Set password icon in the banner and provide the password for \"%s\".",
	ACCESS_DENIED: "Access denied to \"%s\".",
	ERR_NS_RESERVED: "You are not allowed to create a page entitled \"%s\" because namespace \"%s\" is reserved.",
