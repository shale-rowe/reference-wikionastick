...
/*		else {
			...
			//return false;
// PVHL: so far testing shows this is working fine and allows use of the
// multi-file index generated by WoaS. Haven't tested with external images
// but that functionality should be disabled until fixed (corrupts WoaS if
// browser can't save binary with no error given); should work though.
// Only change needed was to adjust the path after loading content.
// BUT! multi-file index should be indicated by a wsif header and set automatically,
// otherwise it is way to easy to corrupt the file. May implement.
		}
*/
