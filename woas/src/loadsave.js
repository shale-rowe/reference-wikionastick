...
woas._save_to_file = function(full) {
	...
	this._clear_plugins();
	// finally put away remaining scripts generated by woas.script.add calls
	this.script.remove_all(true);
...
//	}
	...
	// put back up the script tags generated by custom code
	this.script.restore_all(true);
